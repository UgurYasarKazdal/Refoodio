...
enum class FoodGroup(val id: Int, val titleResId: Int, val iconResId: Int,val colorResId: Int) {
    PRODUCE(id = 1, R.string.section_produce, R.drawable.ic_section_produce,R.color.inventory_produce), // Sebze & Meyve
    PROTEIN(id = 2, R.string.section_protein, R.drawable.ic_section_protein,R.color.inventory_protein), // Et & Balık
    DAIRY(id = 3, R.string.section_dairy, R.drawable.ic_section_dairy,R.color.inventory_dairy),     // Süt Ürünleri
    PANTRY(id = 4, R.string.section_pantry, R.drawable.ic_section_pantry,R.color.inventory_pantry),   // Kiler & Temel Gıda
    OTHER(id = 5, R.string.section_other, R.drawable.ic_section_other, R.color.inventory_other);
